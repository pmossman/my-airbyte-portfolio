...
|--------|------|-------------|--------|
| 1fa14d6294 | Aug 27, 2025 | Permission-based workspace filtering | 6 files, 607 insertions |
| 72aaef63bf | Aug 27, 2025 | Include orgs from non-org permissions | Edge case fix |
| d2991e202e | Aug 29, 2025 | Allow workspace users to call org info | API access |
