...
|--------|------|-------------|--------|
| af83de265f | Nov 5, 2025 | DNS verification service and cron job | 16 files, 1,436 insertions |
| a229cedc02 | Nov 14, 2025 | Delete and reset buttons for Domain Verification UI | UI enhancements |
| cc298d242e | Nov 13, 2025 | "View DNS Info" button for existing verifications | Improved UX |
| c7596a6c84 | Nov 13, 2025 | SSO activation button changes for domain verification | Workflow integration |
