...
|--------|------|-------------|--------|
| [2eacc0d2e5](https://github.com/airbytehq/airbyte-platform/commit/2eacc0d2e5) | Sep 29, 2025 | Add status column to SsoConfig | Schema foundation |
| [fe1917ce1a](https://github.com/airbytehq/airbyte-platform/commit/fe1917ce1a) | Oct 6, 2025 | Draft/activate workflow and endpoints | Core workflow |
| [4e687527e1](https://github.com/airbytehq/airbyte-platform/commit/4e687527e1) | Oct 7, 2025 | SSO validation UI with test flow | Frontend |
| [1afd3bf944](https://github.com/airbytehq/airbyte-platform/commit/1afd3bf944) | Oct 7, 2025 | Token validation endpoint | API |
| [866d7bae4d](https://github.com/airbytehq/airbyte-platform/commit/866d7bae4d) | Oct 8, 2025 | Realm cleanup and user preservation | Error handling |
| [83bfb7b0ef](https://github.com/airbytehq/airbyte-platform/commit/83bfb7b0ef) | Oct 9, 2025 | Consolidated SSO API problems | Error types |
