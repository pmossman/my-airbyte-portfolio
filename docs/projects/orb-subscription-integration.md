...
|--------|------|-------------|--------|
| [8d2a7a3be8](https://github.com/airbytehq/airbyte-platform/commit/8d2a7a3be8) | Dec 2, 2024 | Add subscription_status column | 3 files, 86 insertions |
| [56d17e3e4f](https://github.com/airbytehq/airbyte-platform/commit/56d17e3e4f) | Dec 11, 2024 | Subscription webhook handlers | 6 files, 191 insertions |
| [235018ee8d](https://github.com/airbytehq/airbyte-platform/commit/235018ee8d) | Dec 17, 2024 | Consider subscription_status in sync validation | Integration |
